...
1. Installieren Sie das Plug-in.
    ...
    Laden Sie die aktuelle Version des Plug-ins für die CLI des {{site.data.keyword.cloudaccesstrailshort}}-Service (activity-tracker) von [der {{site.data.keyword.cloud_notm}}-CLI-Seite ![Symbol für externen Link](../../../icons/launch-glyph.svg "Symbol für externen Link")](https://plugins.cloud.ibm.com/ui/repository.html){:new_window} herunter.
...
1. Laden Sie die aktuelle Version des Plug-ins für die CLI des {{site.data.keyword.cloudaccesstrailshort}}-Service (activity-tracker) von [der {{site.data.keyword.cloud_notm}}-CLI-Seite ![Symbol für externen Link](../../../icons/launch-glyph.svg "Symbol für externen Link")](https://plugins.cloud.ibm.com/ui/repository.html){:new_window} herunter. 
